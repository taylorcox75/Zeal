...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { done: @reminder.done, dueDate: @reminder.dueDate, facebook_user_id: @reminder.facebook_user_id, priority: @reminder.priority, query: @reminder.query } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { done: @reminder.done, dueDate: @reminder.dueDate, facebook_user_id: @reminder.facebook_user_id, priority: @reminder.priority, query: @reminder.query } }
